...
window.filesender.Pbkdf2HmacSha256 = Pbkdf2HmacSha256;
console.log("asmcrypto");

window.filesender.asmcryptoR = function() { return {
	Pbkdf2HmacSha256: function(password,salt,count,length) {
		Pbkdf2HmacSha256(password,salt,count,length);
	},
}};
console.log('AAA '  + window.filesender.asmcryptoR);
