...
h3>Oturum aç</h3> 
<ul class="fa-ul">
    <li><i class="fa-li fa fa-caret-right"></i>Standart kurumsal hesabınızı kullanarak aşağıdaki Kimlik Sağlayıcılardan biri üzerinden oturum açabilirsiniz. Kurumunuzu listede görmüyor veya oturum açamıyorsunuz lütfen yerel BT ekibinizle iletişime geçin</li>
</ul>

<h3>Tarayıcınızın özellikleri</h3>
<ul class="fa-ul">
