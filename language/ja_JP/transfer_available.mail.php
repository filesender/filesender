...
{transfer.user_email}が、次のファイルを{cfg:site_name}にアップロードしました。あなたにはそのコンテンツをダウンロードする権限が与えられています:
...
<p>
    <a href="mailto:{transfer.user_email}">{transfer.user_email}</a>が、次のファイルを<a href="{cfg:site_url}">{cfg:site_name}</a>にアップロードしました。あなたにはそのコンテンツをダウンロードする権限が与えられています:
</p>
