...
<ul>
    <li><strong>N&uacute;mero m&aacute;ximo de destinatarios por env&iacute;o: </strong>{cfg:max_email_recipients} direcciones de correo (separadas por comas o puntos y coma).</li>
    ...
    <li><strong>Tama&ntilde;o m&aacute;ximo del archivo por env&iacute;o (Adobe Flash): </strong>{size:cfg:max_legacy_upload_size} </li>
    <li><strong>Tama&ntilde;o m&aacute;ximo del archivo por env&iacute;o (HTML5): </strong>{size:cfg:max_html5_upload_size}</li>
    <li><strong>D&iacute;as hasta la expiraci&oacute;n de un archivo/invitaci&oacute;n de env&iacute;o (m&aacute;ximo): </strong>{cfg:default_days_valid} </li>
</ul>
