<div>
    <div style="padding: 5px; text-align: left;">
        ...
        <ul>
            <li><strong>Nombre maximal de destinataires email: </strong>{cfg:max_email_recipients} adresses email (separées par virgule ou point-virgule)</li>
            ...
            <li><strong>Taille maximale de fichier, pour Adobe Flash : </strong>{size:cfg:max_legacy_upload_size} </li>
            <li><strong>Taille maximale de fichier, pour HTML5 : </strong>{size:cfg:max_transfer_size}</li>
            <li><strong>Nombre maximal de jours pour l'expiration de fichiers / tickets : </strong>{cfg:default_days_valid} </li>
        </ul>
