<div>
    <div style="padding: 5px; text-align: left;">
        ...
        <ul>
            ...
            <li data-feature="nohtml5"><img src="images/html5_none.png" alt="Téléversement HTML5 indisponible" /> Vous pouvez déposer des fichiers d'au maximum {size:cfg:max_legacy_file_size} chacun et jusqu'a {size:cfg:max_transfer_size} par dépôt.</li>
        </ul>
        ...
        <h4>Dépôts vers FileSender jusqu'à {size:cfg:max_legacy_file_size} par fichier sans HTML5</h4>
        <ul>
        ...
        <ul>
            ...
            <li><strong>Taille maximale de fichier pour les navigateur non-compatibles HTML5 : </strong>{size:cfg:max_legacy_file_size} </li>
