...
$lang['av_results_description'] = 'L\'analyse antivirus et anti-malware a été configurée sur ce serveur. Notez que les fichiers cryptés ne peuvent pas être analysés car le serveur ne peut pas décrypter le contenu pour l\'analyser.';
...
$lang['password_can_not_be_part_of_message_error'] = 'Puisque la transmission par courrier électronique peut ne pas être cryptée, vous ne pouvez pas envoyer un message contenant le mot de passe de cryptage. Veuillez modifier le mot de passe ou le supprimer du message pour continuer.';
$lang['password_can_not_be_part_of_message_warning'] = 'Veuillez ne pas envoyer le mot de passe de cryptage dans le contenu  du message. L\'envoi de courriel peut ne pas être crypté et si quelqu\'un intercepte le message, il pourrait télécharger et décrypter votre fichier.';
...
$lang['transfer_must_be_encrypted'] = 'Ce transfert doit être crypté.';
...
$lang['ui2_or_mode_mail'] = 'ou envoyez un lien par e-mail';
...
$lang['upload_all_terasender_workers_completed_pbkdf2'] = 'Tous les workers d\'envoi sont maintenant prêts et devraient transférer des données cryptées.';
...
$lang['use_streamsaver_for_download'] = 'Diffusez les données décryptées directement dans le fichier enregistré. La diffusion en continu des données décryptées directement dans le fichier nécessite moins de mémoire sur votre ordinateur, ce qui vous permet de télécharger des fichiers plus volumineux. Malheureusement, cette fonction n\'est pas prise en charge par tous les navigateurs Web. Votre navigateur devrait prendre en charge cette fonctionnalité, elle a donc été activée par défaut. Si le téléchargement de fichiers cryptés échoue, décochez cette option et réessayez.';
