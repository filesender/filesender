...
$lang['api_secret_aup_text'] = '<h1> Bienvenue sur {cfg:site_name}</h1><p>This site has no additional explicit policy for remote authentication</p>';
$lang['api_secret_delete'] = 'Supprimer l\'API Secrete';
$lang['api_secret_recreate'] = 'Créer l\'API secrete';
...
$lang['confirm_api_secret_delete_all'] = 'Êtes-vous sûr de vouloir supprimer l\'API secrete pour tous les utilisateurs du système ?';
...
$lang['create_user_details'] = 'Lorsque vous créez un nouvel utilisateur, un courriel contenant le mot de passe proposé est envoyé à son adresse électronique et il est conseillé de se connecter et de changer son mot de passe. Si l\'utilisateur existe déjà dans le système et que vous tentez de le créer une deuxième fois, son mot de passe sera remplacé par la valeur que vous avez choisie et l\'e-mail lui sera à nouveau envoyé.';
$lang['created'] = 'Créé';
$lang['created_transfers'] = 'Dépôts créés';
$lang['crypto_pbkdf2_dialog'] = '{cfg:site_name} génère une clé à partir de votre mot de passe, cette fenêtre se fermera automatiquement lorsque la clé sera créée. La génération d\'une clé est une opération coûteuse en calcul pour dissuader les gens d\'essayer de deviner les mots de passe. <br/>Cela peut prendre quelques minutes en fonction de la vitesse de cet ordinateur.';
$lang['crypto_pbkdf2_dialog_with_expected'] = '{cfg:site_name} génère une clé à partir de votre mot de passe, cette fenêtre se fermera automatiquement lorsque la clé sera créée. La génération d\'une clé est une opération coûteuse en calcul pour dissuader les gens d\'essayer de deviner les mots de passe. <br/>Le délai prévu est de {seconds} secondes.';
...
$lang['encrypted_archive_download_overall_progress'] = 'Téléchargement du fichier {currentfilenumber} de {totalfilestodownload}';
...
$lang['event_count'] = 'Nombre d\'événements';
...
$lang['find_users_who_might_be_abusing_the_system'] = 'Trouver les utilisateurs qui pourraient abuser du système';
...
$lang['generate_a_different_password'] = 'Générer un mot de passe différent';
...
$lang['hit_guest_creation_total_limit'] = 'Limitation du taux de création d\'invités';
$lang['hit_guest_remind_rate_limit'] = 'Atteindre la limite du taux de rappel des invités';
...
$lang['most_user_deleted_guests_that_did_not_send_a_single_file'] = 'La plupart des utilisateurs invité supprimé n\'ont pas envoyé un seul fichier.';
$lang['must_be_logged_in_to_download'] = 'L\'utilisateur doit se connecter à {cfg:site_name} pour télécharger le(s) fichier(s).';
$lang['must_be_logged_in_to_download_first_person'] = 'La personne qui a chargé ce(s) fichier(s) exige que vous soyez connecté à {cfg:nom_du_site} afin de pouvoir télécharger les fichiers de ce transfert.';
...
$lang['perform_these_actions_on_all_users'] = 'Effectuez ces actions sur tous les utilisateurs';
...
$lang['search_transfer_by_sender_email_description'] = 'Recherche de transferts par adresse électronique de l\'expéditeur';
$lang['search_transfer_id_inclusive_description'] = 'Recherche de transferts par identifiant de transfert dans une fourchette min et max (inclus)';
$lang['search_transfers'] = 'Rechercher des transferts';
...
$lang['sender_email_search'] = 'E-mail de l\'expéditeur';
...
$lang['show_transfers'] = 'Afficher les transferts';
...
$lang['transfer_information'] = ' Informations sur ce transfert';
...
$lang['transfer_option_modified'] = 'Option de transfert modifiée';
$lang['transfer_presumed_expired'] = ' Le transfert a expiré et les fichiers ont été supprimés de {cfg:site_name}.';
...
$lang['transfers_uid_page'] = 'Transferts de l\'utilisateur';
...
$lang['user_profile_send_client_logs_description_text'] = 'Envoyez les journaux de votre navigateur Web au serveur.';
...
$lang['you_generated_this_auth_secret_at'] = 'Vous avez généré ce secret d\'authentification à : {datetime}';
