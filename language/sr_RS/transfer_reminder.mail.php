...
Ovo je podsetnik da {if:transfer.files>1}su fajlovi transferisani{else}je fajl transferisan{endif} na {cfg:site_name} od {transfer.user_email} i vi imate ovlašćenje za preuzimanje {if:transfer.files>1}njihovog{else}njegovog{endif}  sadržaja :
