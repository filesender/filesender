...
알림 메일입니다. {cfg:site_name}에 접근을 허용하는 바우쳐를 수신했으므로 확인하시기 발랍니다. 이 바우쳐를 이용하면 1회에 한해 파일을 업로드하고 수신자들에 다운로드를 허용할 수 있습니다.
...
<p>
    T알림 메일입니다. <a href="{cfg:site_url}">{cfg:site_name}</a>에 접근을 허용하는 바우쳐를 수신했으므로 확인하시기 발랍니다. 이 바우쳐를 이용하면 1회에 한해 파일을 업로드하고 수신자들에 다운로드를 허용할 수 있습니다.
</p>
