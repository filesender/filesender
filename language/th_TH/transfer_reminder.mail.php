...
// 
?>
เรื่อง: (เตือนความจำ) ไฟล์{if:transfer.files>1}s{endif} พร้อมสำหรับการดาวน์โหลด
หัวเรื่อง: (เตือนความจำ) {transfer.subject}

{ทางเลือก:ธรรมดา}

ถึงคุณหรือคุณนาย,

นี่เป็นการแจ้งเตือน {if:transfer.files>1}ไฟล์มี{else}ไฟล์แล้ว{endif} ต่อไปนี้ได้รับการอัปโหลดไปยัง {cfg:site_name} โดย {transfer.user_email} และคุณได้รับอนุญาตให้ดาวน์โหลด {if :transfer.files>1}เนื้อหา{else}ของพวกเขา{endif} :
...
<p>
     นี่เป็นการแจ้งเตือน {if:transfer.files>1}ไฟล์มี{else}ไฟล์แล้ว{endif} ต่อไปนี้ถูกอัปโหลดไปยัง <a href="{cfg:site_url}">{cfg:site_name}</a> โดย <a href="mailto:{transfer.user_email}">{transfer.user_email}</a> และคุณได้รับอนุญาตให้ดาวน์โหลดเนื้อหา{if:transfer.files>1}ของพวกเขา{else}its{endif} .
</p>
