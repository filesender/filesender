...
$lang['report_event_download_ended'] = 'Příjemce {author.identity} dokončil stahování souboru  {file.name} ({size:file.size})';
$lang['report_event_download_resumed'] = 'Příjemce {author.identity} obnovil stahování souboru  {file.name} ({size:file.size})';
$lang['report_event_download_started'] = 'Příjemce {author.identity} zahájil stahování souboru  {file.name} ({size:file.size})';
$lang['report_event_file_uploaded'] = 'Soubor {file.name} ({size:file.size}) nahrán (trvání {time:time_taken})';
...
$lang['report_owner_event_download_ended'] = 'Vlastník dokončil stahování souboru {file.name} ({size:file.size})';
$lang['report_owner_event_download_resumed'] = 'Vlastník obnovil stahování souboru {file.name} ({size:file.size})';
$lang['report_owner_event_download_started'] = 'Vlastník zahájil stahování souboru {file.name} ({size:file.size})';
...
$lang['report_recipient_event_download_ended'] = 'Příjemce dokončil stahování souboru {file.name} ({size:file.size})';
$lang['report_recipient_event_download_resumed'] = 'Příjemce obnovil stahování souboru {file.name} ({size:file.size})';
$lang['report_recipient_event_download_started'] = 'Příjemce zahájil stahování souboru {file.name} ({size:file.size})';
