...
$lang['file_encryption_description'] = '<i class="fa fa-exclamation-triangle" style="color:#FFAA00" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp; Šifrování souborů je end to end. Vaše soubory jsou zašifrovány ve vašem prohlížeči. Je nutné, abyste šifrovací heslo zaslali příjemci(ům) sami - aplikace žádná hesla neukládá.<br/><i class="fa fa-exclamation-triangle" style="color:#FFAA00" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp; Šifrování souborů může významně ovlivnit výkon a odezvu prohlížeče na straně odesílatele i příjemce.<br/><i class="fa fa-exclamation-triangle" style="color:#FFAA00" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp; Zašifrované souboru větší rovno 4GB nemusí být, z důvodu limitů webového prohlížeče, možné stáhnout.';
$lang['file_encryption_description_disabled'] = '<i class="fa fa-exclamation-triangle" style="color:#FFAA00" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp; Váš prohlížeč není podporován. Zkuste to prosím znovu s poslední verzi Firefoxu, Internet Exploreru, Safari nebo Chrome';
$lang['file_encryption_disabled'] = '<i class="fa fa-exclamation-triangle" style="color:#FFAA00" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;Dešifrování souboru není podporováno vaším prohlížečem. Zkuste to prosím znovu s poslední verzi Firefoxu, Internet Exploreru, Safari nebo Chrome';
