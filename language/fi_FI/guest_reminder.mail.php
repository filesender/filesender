...
// 
?>
subject: Kutsu vastaanotettu (muistutus)

{alternative:plain}

Hei!

Tämä on uusintaviesti eli muistutus: Sinulle on lähetetty palveluun {cfg:site_name} kutsu, jolla pääset jakamaan tiedostosi valitsemillesi vastaanottajille.
...
<p>
   Tämä on uusintaviesti eli muistutus: Sinulle on lähetetty palveluun <a href="{cfg:site_url}">{cfg:site_name}</a> kutsu, jolla pääset jakamaan tiedostosi valitsemillesi vastaanottajille.
</p>
