...
$lang['report_event_download_ended'] = 'Empfänger {author.identity} beendete Download {file.name} ({size:file.size})';
$lang['report_event_download_resumed'] = 'Empfänger {author.identity} hat Download von {file.name} ({size:file.size}) wiederaufgenommen';
$lang['report_event_download_started'] = 'Empfänger {author.identity} begann Download {file.name} ({size:file.size})';
$lang['report_event_file_uploaded'] = 'Die Datei {file.name} ({size:file.size}) wurde hochgeladen (took {time:time_taken})';
...
$lang['report_owner_event_download_ended'] = 'Ersteller beendete den Download von {file.name} ({size:file.size})';
$lang['report_owner_event_download_resumed'] = 'Ersteller setzte den Download von {file.name} ({size:file.size}) fort';
$lang['report_owner_event_download_started'] = 'Ersteller begann den Download von {file.name} ({size:file.size})';
...
$lang['report_recipient_event_download_ended'] = 'Empfänger beendete den Download {file.name} ({size:file.size})';
$lang['report_recipient_event_download_resumed'] = 'Empfänger setzte den Download von  {file.name} ({size:file.size}) fort';
$lang['report_recipient_event_download_started'] = 'Empfänger begann den Download von {file.name} ({size:file.size})';
