Betreff: Datei{if:transfer.files>1}en{endif} erfolgreich hochgeladen
...
<p>
    die {if:transfer.files>1}folgenden Dateien wurden{else}folgende Datei wurde{endif} erfolgreich nach <a href="{cfg:site_url}">{cfg:site_name}</a> hochgeladen.
</p>
