...
?>
    <div class="container">
        <div class="row">
            <div class="col-4">
                <h3>{tr:top_users}</h3>
                <table class="fs-table fs-table--striped fs-table--scroll">
...
qld-gdpt-fsappdev1:/filesender#
qld-gdpt-fsappdev1:/filesender#
qld-gdpt-fsappdev1:/filesender# vim config/language/en_AU/
guest_created.mail.php           lang.php                         translate_email_footer.mail.php
qld-gdpt-fsappdev1:/filesender# vim config/language/en_AU/
guest_created.mail.php           lang.php                         translate_email_footer.mail.php
qld-gdpt-fsappdev1:/filesender# vim config/language/en_AU/lang.php
qld-gdpt-fsappdev1:/filesender# vim templates/statistics_page.php
qld-gdpt-fsappdev1:/filesender# cat templates/statistics_page.php
<?php
include_once "pagemenuitem.php";
$idp = Auth::getTenantAdminIDP();
?>
