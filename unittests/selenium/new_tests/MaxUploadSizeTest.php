...
class MaxUploadSizeTest extends BasisTest
{
    ...
    {
        if (!$this->isCheckBoxSelected('#get_a_link')){
            $this->clickCheckbox('#get_a_link');
        }

        $this->byCssSelector(".file_selector input[name=\"files\"]")->value(getcwd()."/unittests/selenium/assets/".$file_name);
