...
* Built-in support for SimpleSAMLphp, OpenIDConnectClient and Shibboleth authentication libraries
* In practice this means SAML2, OpenID Connect, LDAP, RADIUS, Active Directory, Facebook, etc.
