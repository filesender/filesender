...
* __comment:__ This is a list of the classes to use to check for bad content. They can only run on non encrypted files as the
               ...
               classes/avprograms/AVProgramURLTest.php. The AVProgramURLTest.php can be installed on a web server and will fail content that
               contains a bad word which in this case is literally "badword". The AVProgramURLTest is provided as an example
