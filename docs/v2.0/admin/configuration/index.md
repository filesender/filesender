...
* __comment:__ This is a list of the classes to use to check for bad content. They can only run on non encrypted files as the
               ...
               From an implementation perspective, results are recorded in the AVResults table and the download page will display the results of scans if they are available.
