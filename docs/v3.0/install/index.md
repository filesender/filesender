...
/root/src/filesender-3.0.tar.gz. The tarball will include the release
...
cd       /opt/filesender
tar xzvf /root/src/filesender-3.0.tar.gz
...
Install the FileSender 3.0 beta branch from the GIT repository use the
...
In the example code below I am going to use version filesender-3.0.
...
shows the version currently used there. For the FileSender 3.0 release
...
and migration script to use. This setup requires the code in FileSender release 3.0 or above to work.
